...
\item \textbf{Deliverables:} 
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            \includegraphics{pics/loss_train1.png}
        ...
        \begin{figure}[H]
            \centering
            % TODO: put your plot here.
            \includegraphics{pics/mAP_1.png}
        ...
        \begin{figure}[H]
            \centering
            % TODO: put your plot here.
            \includegraphics{pics/loss_train_cnn.png}
        ...
        \begin{figure}[H]
            \centering
            % TODO: put your plot here.
            \includegraphics{pics/mAP_cnn.png}
        ...
        \begin{figure}[H]
            \centering
            % TODO: put your plot here.
            \includegraphics{pics/lr_cnn.png}
        ...
        \begin{solution}
        \\
            Here are my final hyperparameters \textbf{lr: 1e-3, batch size: 64, step size: 1, gamma: 0.9}, \\
            I also tried \textbf{step size: 2, gamma: 0.9} and \textbf{gamma: 0.87}, and an \textbf{lr: 1e-2}.
            None of those iterations really had much effect except on the loss which achieved down to 0.13 on some iterations with a \textbf{batch size:32}.
            But the largest change to mAP was increasing the \textbf{batch size} to 64 which increased mAP by 0.02 or 10.
            However, the loss did not really change much across the epochs. Likely too quick of a decrease for that batch size,
            but the mAP was actually 0.242 so I called it a win. 
        \end{solution}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/lr_resnet.png}
        ...
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/mAP_resnet.png}
        ...
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/loss_train_resnet.png}
        ...
        \begin{solution}
        \\ So this was less of a problem when I switched to focal loss because BCE with label smoothing couldn’t get me there no matter what I did. And during that time, the mAP would improve rapidly and remain high for the first 10-20 epochs, and degrade or even collapse as the model improved according to the loss. This still happened ever so slightly with focal loss, but not nearly as bad as you can see as the two stayed relatively converged throughout training. So I determined that the regularization of the training images was the problem after extensive hyperparameter and data augmentation tuning, and changed my loss.
        \end{solution}
        
        \begin{figure}[H]
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/hist_conv1.png}
        ...
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/hist_bn4.png}
        ...
        \centering
        % TODO: put your plot here.
        \includegraphics{pics/t_sne.png}
        \caption{t-SNE}
        \label{fig:q2_tsne}
        \end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{I wasn’t sure which loss curve you wanted so I went to the detection helper script and added a total loss function and am adding them all here:}
        % TODO ADD YOUR FIGURE HERE.
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_total_overfit.png}
            \caption{Total Loss Overfitting Training Curve}
            \label{fig:overfit_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_box_overfit.png}
            \caption{Box Loss Overfitting Training Curve}
            \label{fig:overfit_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_cls_overfit.png}
            \caption{CLS Loss Overfitting Training Curve}
            \label{fig:overfit_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_ctr_overfit.png}
            \caption{Loss Ctr Overfitting Training Curve}
            \label{fig:overfit_plot}
        \end{figure}
        ...
        \item \textbf{Same consideration as above}
        % TODO ADD YOUR FIGURE HERE.
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_total_full.png}
            \caption{Total Loss Full Training Curve}
            \label{fig:full_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_box_full.png}
            \caption{Box Loss Full Training Curve}
            \label{fig:full_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_cls_full.png}
            \caption{CLS Loss Full Training Curve}
            \label{fig:full_plot}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics{pics/loss_ctr_full.png}
            \caption{Loss Ctr Full Training Curve}
            \label{fig:full_plot}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics{pics/mAP_plot.png}
            \caption{mAP plots}
            \label{fig:final_mAP}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics{pics/tensorboard_inference.png}
        ...
        \begin{solution}
        \\ We can generally infer that the model does well on large, clearly distinct objects like trains, planes, singular animals, etc., but it does poorly in partially occluded or crowded objects like sheep and boats, (though admittedly I believe there are fewer of these classes in this dataset). So I would probably move to focal loss rather than the centerness which I believe is a weakness here, adapt to localization/feature alignment error  in the model, handle class-balanced sampling or additional data augmentations on those limited classes with stronger data augmentations overall.
        \end{solution}
