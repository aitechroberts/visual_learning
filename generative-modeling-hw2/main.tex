...
\begin{solution}
\\
Vanilla GAN FID: 142.18 (Reached down to about 63 but then went back up, and I could not keep it from collapsing back up)
\\
\begin{figure}[H]
    \centering
    % TODO: put your plot here.
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_gan/samples_30000.png}
        \caption{Vanilla GAN Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_gan/interpolations_30000.png/latent_interpolations.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_ls_gan/samples_30000.png}
        \caption{LS-GAN Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_ls_gan/interpolations_30000.png/latent_interpolations.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_wgan_gp/samples_30000.png}
        \caption{WGAN-GP Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{gan/data_wgan_gp/interpolations_30000.png/latent_interpolations.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\linewidth]{vae/data/ae_latent16/recon_loss_vs_iterations.png}
    \caption{Loss (size 16)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{vae/data/ae_latent128/recon_loss_vs_iterations.png}
        \caption{Loss: (size 128)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{vae/data/ae_latent1024/recon_loss_vs_iterations.png}
        \caption{Loss: (size 1024)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/ae_latent16/epoch_20_recons.png}
    \caption{Reconstructions: (size 16)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{vae/data/ae_latent128/epoch_20_recons.png}
        \caption{Reconstructions: (size 128)}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{vae/data/ae_latent1024/epoch_20_recons.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_.8/recon_loss_vs_iterations.png}
    \caption{Recon. Loss: constant $\beta^*$}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_.8/kl_loss_vs_iterations.png}
    \caption{KL Loss: constant $\beta^*$}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_.8/epoch_20_samples.png}
    \caption{Samples: constant $\beta^*$}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_annealing/recon_loss_vs_iterations.png}
    \caption{Recon. Loss: $\beta$ annealed}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_annealing/kl_loss_vs_iterations.png}
    \caption{KL Loss: $\beta$ annealed}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{vae/data/vae_latent_beta_annealing/epoch_20_samples.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{flow_matching/flow_euler/samples_euler.png}
...
\begin{solution}
    \\ The flow matching model seems to generate far sharper pictures than the VAE. However, given the resolution it is hard to tell the difference between the regular AE and the flow matching model though the flow matching model does seem a bit sharper though they both look similar. Interestingly, both are far better than the VAE with KL-Divergence and the Beta term, though it would be interesting to try to limit Beta toward the end following a warmup or attempt a cyclical annealing method.
\end{solution}
