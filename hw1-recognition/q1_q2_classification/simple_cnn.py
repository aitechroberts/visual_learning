...
class SimpleCNN(nn.Module):
    ...
    def __init__(self, num_classes=10, inp_size=28, c_dim=1):
        ...
        self.conv1 = nn.Conv2d(c_dim, 32, 5, padding=2) # (batch, 32, 28, 28)
        self.conv2 = nn.Conv2d(32, 64, 5, padding=2) # (batch, 64, 14, 14)
        self.nonlinear = nn.ReLU()
        self.pool1 = nn.AvgPool2d(2, 2) # (batch, 32, 14, 14)
        self.pool2 = nn.AvgPool2d(2, 2) # (batch, 64, 7, 7)

        # TODO set the correct dim here
        self.flat_dim = 64 * 16 * 16
        # would otherwise not hardcode this
